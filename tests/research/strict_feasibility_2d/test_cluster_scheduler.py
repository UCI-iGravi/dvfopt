...
def test_continuous_matches_subround_feasibility_and_l1():
    ...
    out_sub, _ = cluster_slp_iter(phi, threshold=0.01, n_workers=2, scheduler='subround')
    out_con, _ = cluster_slp_iter(phi, threshold=0.01, n_workers=2, scheduler='continuous')
