...
| `cohort_ds2/<brain>_<variant>_ds2.npy` | exact 2x block-mean downsample of one cohort volume, `(3, 264, 160, 228)` float64, displacements halved — a smaller full-volume artefact for the 3D windowed engine's banded driver | `python benchmarks/windowed_3d_full.py --build-ds2 <brain> [--variant laplacian_exterior]` (`dvfopt.core.wallbreakers._multiscale_3d._downsample_2x`) |
