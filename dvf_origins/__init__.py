...
CASES = {
    ...
    # template (RegTools outputs, external), test pair = B0039 at z=264 like the m1/m4 rows
    'm3_voxelmorph_direct_cohort': (
        3,
        learned.voxelmorph,
        dict(seed=0, integration_steps=0, data='cohort'),
    ),
    'm3_voxelmorph_diffeo_cohort': (
        3,
        learned.voxelmorph,
        dict(seed=0, integration_steps=7, data='cohort'),
    ),
